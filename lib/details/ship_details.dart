...
import 'package:crispy_booking/reservation/reservation_ship_screen.dart';
            ...
            child: ElevatedButton(
              onPressed: () {
                Navigator.push(
                    ...
                    MaterialPageRoute(
                        builder: (context) =>
                            const ReservationOptionsScreen()));
              },
                      ...
                      SizedBox(
                        ...
                        child: ClipRRect(
                          ...
                          child: Image.asset(
                            width: screenWidth,
                            height: screenHeight * 0.4,
                            Assets.yachtForSale, // Replace with your image URL
                            fit: BoxFit.cover,
                          ),
                        ),
                      ),
