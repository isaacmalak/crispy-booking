...
class ReservationOptionsScreen extends StatelessWidget {
  const ReservationOptionsScreen({super.key});
              ...
              child: Container(
                ...
                child: Center(
                  child: SvgPicture.asset(
                    ...
                    width: 0.05 * screenWidth, // Size you want for the SVG icon
                    height:
                        0.026 * screenHeight, // Size you want for the SVG icon
                    fit: BoxFit.contain, // Ensure the image stays within bounds
                  ),
                ),
              ),
                      ...
                      Row(
                        children: [
                          SizedBox(
                            ...
                            child: Image.asset(Assets.yachtForSale),
                          ),
